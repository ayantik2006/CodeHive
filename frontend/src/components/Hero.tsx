  ...
  return (
    <div className="min-h-screen bg-[#0F0F10] flex flex-col gap-5 [@media(max-width:1449px)]:items-center">
      ...
      <div className="flex flex-wrap gap-5 px-[13rem] [@media(max-width:786px)]:px-2 mt-[-1rem] items-center justify-center">
        ...
        <div className="w-[16rem] h-[12rem] bg-[#151518] border-1 border-gray-800 rounded-[0.7rem] p-5 flex flex-col gap-[1rem] hover:scale-[1.02] duration-300">
            <h1 className="flex text-white items-center gap-2 text-[1.3rem] font-semibold"><UsersRound size={30} className="text-[#6c41d0] fill-[#6c41d0]"/>Shared cursors</h1>
            <p className="text-[#7A7B7D]">
                See where others are working in the editor
            </p>
        </div>
        <div className="w-[16rem] h-[12rem] bg-[#151518] border-1 border-gray-800 rounded-[0.7rem] p-5 flex flex-col gap-[1rem] hover:scale-[1.02] duration-300">
            <h1 className="flex text-white items-center gap-2 text-[1.3rem] font-semibold"><MessageCircle  size={30} className="text-[#6c41d0] fill-[rgb(108,65,208)]"/>Live Chat</h1>
            <p className="text-[#7A7B7D]">
                Chat with your collaborators instantly
            </p>
        </div>
        <div className="w-[16rem] h-[12rem] bg-[#151518] border-1 border-gray-800 rounded-[0.7rem] p-5 flex flex-col gap-[1rem] hover:scale-[1.02] duration-300">
            <h1 className="flex text-white items-center gap-2 text-[1.3rem] font-semibold"><CloudUpload  size={30} className="text-[#6c41d0] fill-[rgb(108,65,208)]"/>Cloud Saves</h1>
            <p className="text-[#7A7B7D]">
